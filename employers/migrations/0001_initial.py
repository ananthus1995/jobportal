...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('applied', 'applied'), ('accepted', 'accepted'), ('rejected', 'rejected'), ('pending', 'pending'), ('cancelled', 'cancelled')], default='applied', max_length=20)),
                ...
                ('job', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='employers.jobs')),
            ],
            options={
